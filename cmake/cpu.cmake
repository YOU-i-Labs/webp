...
elseif(IOS OR TVOS)
  set(SIMD_ENABLE_FLAGS ";-msse4.1;-mavx2;-mips32;-mdspr2;-mfpu=neon;-mmsa")
  set(SIMD_DISABLE_FLAGS ";-mno-sse4.1;-mno-avx2;;;;")
else()
  set(SIMD_ENABLE_FLAGS ";-msse4.1;-mavx2;-mips32;-mdspr2;-mfpu=neon;-mmsa")
  set(SIMD_DISABLE_FLAGS ";-mno-sse4.1;-mno-avx2;;-mno-dspr2;;-mno-msa")
endif()
